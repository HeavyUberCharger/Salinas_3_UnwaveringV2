...
public class Unwavering2 extends BasicGameState {
	...
	public Unwavering2(int xSize, int ySize) {
	...
	throws SlickException {
		...
		grassMap = new TiledMap("res/d2.tmx");
		...
		blocked2.blocked = new boolean[grassMap.getWidth()][grassMap.getHeight()];
		...
		System.out.println("Array length" + blocked2.blocked[0].length);
		...
		for (int xAxis = 0; xAxis < grassMap.getWidth(); xAxis++) {
			for (int yAxis = 0; yAxis < grassMap.getHeight(); yAxis++) {
				...
				if (!blocked2.blocked[xBlock][yBlock]) {
		...
		stuffwin.add(antidote);
                ...
                bonusitem = new Itembonus(312,652);
                bonusitem1 = new Itembonus(128,1352);
                bonusitem2 = new Itembonus(877,2402);
                bonusitem3 = new Itembonus(1357,1681);
                bonusitem4 = new Itembonus(2172,2160);
                bonusitem5 = new Itembonus(3048,2186);
                bonusitem6 = new Itembonus(3025,470);
                bonusitem7 = new Itembonus(1566,469);
                bonusitem8 = new Itembonus(2055,342);
                bonusitem9 = new Itembonus(1587,2409);
