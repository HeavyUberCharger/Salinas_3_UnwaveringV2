...
public class Unwavering extends BasicGameState {
	...
	throws SlickException {
		...
		blocked1.blocked = new boolean[grassMap.getWidth()][grassMap.getHeight()];
		...
		for (int xAxis = 0; xAxis < grassMap.getWidth(); xAxis++) {
			for (int yAxis = 0; yAxis < grassMap.getHeight(); yAxis++) {
				...
				if (!blocked1.blocked[xBlock][yBlock]) {
		...
		stuffwin.add(antidote);
                ...
                bonusitem = new Itembonus(1294,324);
                bonusitem1 = new Itembonus(1110,1507);
                bonusitem2 = new Itembonus(335,1140);
                bonusitem3 = new Itembonus(95,2510);
                bonusitem4 = new Itembonus(1495,1893);
                bonusitem5 = new Itembonus(1693,818);
                bonusitem6 = new Itembonus(1522,1108);
                bonusitem7 = new Itembonus(2246,1372);
                bonusitem8 = new Itembonus(3042,1738);
                bonusitem9 = new Itembonus(2099,276);
	...
	private boolean isBlocked(float tx, float ty) {
		...
		return blocked1.blocked[xBlock][yBlock];
